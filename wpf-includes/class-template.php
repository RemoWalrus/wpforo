...
class wpForoTemplate{
	...
	function init_nav_menu(){
		...
		WPF()->menu['wpforo-home'] = array(
			...
			'label'     => wpforo_phrase( 'rooms', false ),
            ...
            <div class="wpf-topic-forum-field" style="padding: 0 10px 15px; text-align: center; margin: 0 auto 10px;">
                ...
                <div class="wpf-topic-forum-wrap" style="width: 70%; margin: 0 auto; padding-bottom: 15px; min-width: 222px; border-bottom: 1px dashed #cccccc;">
                    <select id="wpf-choose-forum-<?php echo $uniqid ?>" class="wpf-topic-form-forumid" style="width: 100%; max-width: 100%;">
                        <option class="wpf-topic-form-no-selected-forum" value="0">-- <?php wpforo_phrase('No room selected'); ?> --</option>
	...
	*/
            ...
            <form id="wpf_topicmoveform" method="POST" enctype="multipart/form-data" action="">
                ...
                <ul>
                    <li>
                        <div id="wpf_movedialog" title="<?php esc_attr(wpforo_phrase('Move topic')) ?>">
                            <div class="form-field">
                                ...
                                <label for="spl-target-url" class="wpf-input-label" style="padding-bottom: 7px;"><?php wpforo_phrase('Choose Target Room') ?><sup>*</sup></label>
                    ...
                    <li style="padding-top: 20px;"><i class="fas fa-info-circle wpfcl-5" style="font-size: 16px;"></i>
                        &nbsp;<?php wpforo_phrase('This action changes topic URL. Once the topic is moved to other room the old URL of this topic will no longer be available.') ?>
                    </li>
	...
	function breadcrumb( $current_object = null ){
		...
		<?php switch($current_object['template']) :
                case 'search': ?>
                    <div itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" class="wpf-item-element wpf-root" ><a itemprop="item" href="<?php echo wpforo_home_url() ?>" title="<?php esc_attr( wpforo_phrase('Rooms') ) ?>"><i class="fas fa-home"></i><span itemprop="name" style="display:none;"><?php wpforo_phrase('Rooms') ?></span></a><meta itemprop="position" content="1"></div>
                ...
                <?php break; default: ?>
                    <?php if( $current_object['forumid'] ): ?>
                        ...
                        <a href="#" class="wpf-end">&nbsp;</a>
                    <?php else: ?>
                    <div itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" class="wpf-item-element wpf-root active"><a itemprop="item" href="<?php echo wpforo_home_url() ?>" title="<?php esc_attr( wpforo_phrase('Rooms') ) ?>"><span itemprop="name"><?php wpforo_phrase('Rooms') ?></span></a><meta itemprop="position" content="1"></div>
                        <a href="#" class="wpf-end">&nbsp;</a>
                    <?php endif ?>
			<?php endswitch; ?>
		</div>
